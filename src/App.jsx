      ...
      <div className='d-flex f-container'>
        <div className=' first p-4'>
          <div className='d-flex flex-column h-100 justify-content-between'>
            ...
            <h2 className='tagline text-start ms-4'>Say hello to global food and beverage producers and suppliers, all in one place</h2>
          </div>
        ...
        <div className=''>
          <div className='reg-form d-flex justify-content-around flex-column p-2 px-5'>
            ...
            <form className=' d-flex flex-column justify-content-between' action="">
              ...
              <button onClick={(e)=> e.preventDefault()} className='mt-5 p-4'>Sign up</button>
            </form>
